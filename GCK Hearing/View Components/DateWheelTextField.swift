//
//  DateTextField.swift
//  Inspired by Szymon Lorenz, originally created on 2/22/20
//  Updated by Sharrar Wasit on 3/22/24
...
struct DateTextField: UIViewRepresentable {
    ...
    init(date: Binding<Date>, dateString: Binding<String>,
